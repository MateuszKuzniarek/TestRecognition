...
Podczas tego eksperymentu wykorzystano zbiór artykułów agencji Reuters, 3 słowa kluczowe na klasę, własny ekstraktor oraz parametr k o wartości 7. Klasyfikację przeprowadzono wględem kategorii places.
...
\begin{table}[h]
	...
	\begin{tabular}{l|l|l}
		...
		\hline
		Metryka euklidesowa&79.7&17.612\\
		Metryka taksówkarska&79.7&18.713\\
		Metryka Czebyszewa&85.6&97.608\\
		Średnia arytmetyczna-minimum&79.7&77.398\\
		Minimum-maximum&79.7&67.455\\
		Własna miara podobieńśtwa&79.7&75.206\\
	\end{tabular}
\end{table}
\subsection{Eksperyment 4. Wpływ normalizacji na klasyfikację}
...
\begin{table}[h]
	...
	\begin{tabular}{l|l|l|l|l|l|l}
		...
		Ekstraktor& TF & TFIDF & Własny & TF & TFIDF & Własny\\
		\hline
		skuteczność [\%]   &86.3&86.3&7.04&86.5&86.5&84.6\\
